...
public class DaysRecyclerAdapter4 extends RecyclerView.Adapter<DaysRecyclerAdapter4.ViewHolder>  {

    private ArrayList<CalendarRow4> mCalendarRows = new ArrayList<>();
    private OnDayListener mOnDayListener;

    public DaysRecyclerAdapter4(ArrayList<CalendarRow4> calendarRows, OnDayListener onDayListener) {
