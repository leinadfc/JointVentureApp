...
public class AddActivity1 extends AppCompatActivity {
    ...
    private CalendarRow1 mCalendarRow;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.addpg:
                        break;
                    case R.id.calpg:
                        Intent i = new Intent(AddActivity1.this, CalendarActivity.class);
                        startActivity(i);
                        break;

                    case R.id.graphpg:
                        Intent ii = new Intent(AddActivity1.this, GraphsActivity.class);
                        startActivity(ii);
                        break;
                }
                return false;
