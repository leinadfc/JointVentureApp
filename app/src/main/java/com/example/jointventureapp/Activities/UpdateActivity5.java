...
public class UpdateActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_activity_5);
        ...
        botNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.addpg:
                        Intent iii = new Intent(UpdateActivity5.this, AddActivity5.class);
                        startActivity(iii);
                        finish();
                        break;
                    case R.id.calpg:
                        Intent ii = new Intent(UpdateActivity5.this, CalendarActivity.class);
                        startActivity(ii);
                        finish();
                        break;
                    ...
                    case R.id.graphpg:
                        if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 5) {
                            Intent i = new Intent(UpdateActivity5.this, GraphsActivity5.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 4){
                            Intent i = new Intent(UpdateActivity5.this, GraphsActivity4.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 3){
                            Intent i = new Intent(UpdateActivity5.this, GraphsActivity.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 2){
                            Intent i = new Intent(UpdateActivity5.this, GraphsActivity2.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 1){
                            Intent i = new Intent(UpdateActivity5.this, GraphsActivity1.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 0){
                            Intent i = new Intent(UpdateActivity5.this, GraphsActivity0.class);
                            startActivity(i);
                        }
                        finish();
                        break;
        ...
        if (mCalendarRow.getSymptomText1().equals(symptomNames.get(4))){
            symptom5.setText(symptomNames.get(4));
            seekBar5.setProgress(mCalendarRow.getProgress1());
        }
        else if (mCalendarRow.getSymptomText2().equals(symptomNames.get(4))){
            symptom5.setText(symptomNames.get(4));
            seekBar5.setProgress(mCalendarRow.getProgress2());
        }
        else if (mCalendarRow.getSymptomText3().equals(symptomNames.get(4))){
            symptom5.setText(symptomNames.get(4));
            seekBar5.setProgress(mCalendarRow.getProgress3());
        }
        else if (mCalendarRow.getSymptomText4().equals(symptomNames.get(4))){
            symptom5.setText(symptomNames.get(4));
            seekBar5.setProgress(mCalendarRow.getProgress4());
        }
        else if (mCalendarRow.getSymptomText5().equals(symptomNames.get(4))){
            symptom5.setText(symptomNames.get(4));
            seekBar5.setProgress(mCalendarRow.getProgress5());
        }
        else {
            symptom5.setText(symptomNames.get(4));
        ...
        mDisplayDay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(
                        UpdateActivity5.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,
        ...
        adbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (PreferenceUtils.getSymptomCount(getApplicationContext()) > 2) {
                    ...
                    Intent i = new Intent(UpdateActivity5.this, CalendarActivity2.class);
                    startActivity(i);
                }
                else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 1){
                    Intent i = new Intent(UpdateActivity5.this, CalendarActivity1.class);
                    startActivity(i);
                }
                else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 0){
