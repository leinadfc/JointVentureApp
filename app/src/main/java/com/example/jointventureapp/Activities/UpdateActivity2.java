    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.addpg:
                        Intent iii = new Intent(UpdateActivity2.this, AddActivity2.class);
                        startActivity(iii);
                        finish();
                        break;
                    case R.id.calpg:
                        Intent ii = new Intent(UpdateActivity2.this, CalendarActivity2.class);
                        startActivity(ii);
                        finish();
                        break;
                    ...
                    case R.id.graphpg:
                        if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 5) {
                            Intent i = new Intent(UpdateActivity2.this, GraphsActivity5.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 4){
                            Intent i = new Intent(UpdateActivity2.this, GraphsActivity4.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 3){
                            Intent i = new Intent(UpdateActivity2.this, GraphsActivity.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 2){
                            Intent i = new Intent(UpdateActivity2.this, GraphsActivity2.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 1){
                            Intent i = new Intent(UpdateActivity2.this, GraphsActivity1.class);
                            startActivity(i);
                        }
                        else if (PreferenceUtils.getSymptomCount(getApplicationContext()) == 0){
                            Intent i = new Intent(UpdateActivity2.this, GraphsActivity0.class);
                            startActivity(i);
                        }
                        finish();
                        break;
        ...
        mDisplayDay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(
                        UpdateActivity2.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth,
        ...
        adbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(UpdateActivity2.this, CalendarActivity2.class);
                startActivity(i);
