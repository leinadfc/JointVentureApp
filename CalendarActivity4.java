...
import com.example.jointventureapp.Adapters.DaysRecyclerAdapter4;
...
public class CalendarActivity4 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, DaysRecyclerAdapter4.OnDayListener {
    ...
    private DaysRecyclerAdapter4 mDaysRecyclerAdapter4;
    private DayRepository4 mDayRepository4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDayRepository4 = new DayRepository4(this);
        ...
        botNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.addpg:
                        Intent i = new Intent(CalendarActivity4.this, AddActivity.class);
                        startActivity(i);
                        break;
                    case R.id.calpg:
                        break;
                    ...
                    case R.id.graphpg:
                        Intent ii = new Intent(CalendarActivity4.this, GraphsActivity.class);
                        startActivity(ii);
                        break;
                }
                return false;
    ...
    private void initRecyclerView (){
        ...
        mDaysRecyclerAdapter4 = new DaysRecyclerAdapter4(mCalendarRows, this);
        recyclerView.setAdapter(mDaysRecyclerAdapter4);
    }
    ...
    private void retrieveDays(String month, String year){
        mDayRepository4.retrieveDaysTask(month, year).observe(this, new Observer<List<CalendarRow4>>() {
            @Override
            public void onChanged(@Nullable List<CalendarRow4> calendarRows) {
                ...
                mDaysRecyclerAdapter4.notifyDataSetChanged();
            }
        });
    }
