...
public class CalendarActivity2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, DaysRecyclerAdapter2.OnDayListener {
    ...
    private DayRepository2 mDayRepository2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDayRepository2 = new DayRepository2(this);
        ...
        botNavView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.graphpg:
                        Intent ii = new Intent(CalendarActivity2.this, GraphsActivity.class);
                        startActivity(ii);
                        break;
                }
                return false;
    ...
    private void retrieveDays(String month, String year){
        mDayRepository2.retrieveDaysTask(month, year).observe(this, new Observer<List<CalendarRow2>>() {
            @Override
